...
<nav class="ink-navigation" id="nav">
    <ul class="menu horizontal black" id="nav" >
        <span class="align-center push-center">
            <li> <a href="/cretin_app_analytics/server.php/home"><i class="fa fa-home fa-2x"></i><br/>ホーム</a></li>
            @if( !isset($type) || $type != 6 )
            <li> <a href="/cretin_app_analytics/server.php/analytics"><i class="fa fa-line-chart fa-2x"></i><br/>インストール数計測</a></li>
            @endif
            <li><a href="/cretin_app_analytics/server.php/graph_analytics"><i class="fa fa-bar-chart fa-2x"></i><br/>グラフ表示</a></li>
            <li> <a  href="/cretin_app_analytics/server.php/change_password"><i class="fa fa-unlock-alt fa-2x"></i><br/>パスワードを変更する</a></li>
            <li><a  href="/cretin_app_analytics/server.php/logout"><i class="fa fa-sign-out fa-2x"></i><br/>ログアウト</a></li>
        </span>
    </ul>
</nav>
