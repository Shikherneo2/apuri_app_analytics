                    ...
                    @endif
                        <form  class="ink-form ink-formvalidator" id="employee" role="form" method="POST" action="/cretin_app_analytics/server.php/reset-password">
                            ...
                            <div class="control-group align-center">
                                <label for="userid" id="userid" class="align-right" style="font-size: 16px;">We will send you the password on you Email.</label>
                                <div class="control">
                                    <input type="text" data-rules="required" placeholder="User ID" id="userid" class="form-control" name="userid">
                                </div>
                            </div>
                            <input type="submit" value="Reset Password" id="reset" class="ink-button blue align-center">
                        </form>
                    </div>
                </div>
            </div>
