...
@section('content')
    ...
    <form class="ink-form ink-formvalidator" id="employee" method="post" role="form" action="addShop_employee" >
        ...
        <div class="control-group required">
            <div class="control">
                <input placeholder="Name" type="text" data-rules="required|text[true,false]" name="name" id="name" />
            </div>
        </div>
        ...
        <div class="control-group required">
            <div class="control input_container ink-navigation">
                <input placeholder="Shop Name" type="text" name="shop_id" onkeyup='autocomplet("{{csrf_token()}}")' id="shop_id" data-rules="required|text[true,false]" autocomplete="off"/>
        ...
        <div class="control-group required">
          <div class="control">
                <input placeholder="Email" type="text" name="email" id="e-mail" data-rules="required|email" />
            </div>

        <div class="button-group horizontal-gutters" style="margin-top:15px;">
        <input type="submit" name="Add" id="add" value="Add Employee" class="ink-button blue push-left gutters" />
        <input type="button" class="ink-button grey push-center gutters" value="Upload New CSV" id="uploadBtn" style="width:300px;" accept="csv/*">
        </div>
                ...
                @if( !empty($uploaded_csv) )
                    <div id="uploaded_csv_box" class="control-group gutters" style="margin-top:10px;margin-bottom:15px;">
                        <a href="/cretin_app_analytics/server.php/addShop_employee_from_csv" style="display:table-cell;">
                            <input type=button id="add_users" class="ink-button green" value="Add users from CSV"></a>
                        <p style="display:table-cell;padding-left:10px;vertical-align:middle;">( We also have a previously uploaded CSV file.)</p> 
                    </div>
                @endif

                <a class="active" href="/cretin_app_analytics/public/uploads/example.csv">Download Sample file</a>
        </div>
   </form>
    <br/>
